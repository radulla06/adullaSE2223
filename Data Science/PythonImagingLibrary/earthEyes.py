...
student_img_2 = PIL.Image.open(student_file)
earth_small_2 = earth_img.resize((75, 84))
student_img_2.paste(earth_small_2, (708, 940))
fig4, axes4 = plt.subplots(1, 2)
axes4[0].imshow(student_img_2, interpolation='none')
axes4[1].imshow(student_img_2, interpolation='none')
